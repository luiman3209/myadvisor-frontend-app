...
import { Bell, CalendarPlus, MessagesSquare, Rocket, Search, Star } from 'lucide-react';
...
import BarChart from '@/components/HomeBannerChart';
...
export default function Home() {
  ...
  return <div className='flex flex-col min-h-screen bg-cyan-500'>
    <Navbar />
